...
# cтворення спрайтів
player = Player('hero1.png',10,400,5)
monster = Enemy('cyborg.png',350,250,5)
final=GameSprite("treasure.png",1100,600,0)
#  створення стін
w1 = Wall(0,0,0, 0, 44 , 45, 625)
w2 = Wall(0,0,0, 0, 0, 1280, 45)
w3 = Wall(0,0,0, 1250, 0 , 45, 720)
w4 = Wall(0,0,0, 0, 680, 1280, 45)
w5 = Wall(0,0,0, 170, 150, 45, 540)
w6 = Wall(0,0,0, 200, 265, 175, 45)
w7 = Wall(0,0,0, 380, 150, 45, 380)
w8 = Wall(0,0,0, 530, 135, 80, 45)
w9 = Wall(0,0,0, 550, 475, 45, 215)
w10 = Wall(0,0,0, 680, 0, 45, 255)
w11 = Wall(0,0,0, 845, 280, 45, 225)
w12 = Wall(0,0,0, 1145, 280, 45, 225)
w13 = Wall(0,0,0, 845, 500, 175, 45)
w14 = Wall(0,0,0, 900, 175, 175, 45)
# ігорвий цикл
while game:
